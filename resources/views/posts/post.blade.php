...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header header">Add Post</div>
                    ...
                    <div class="col-md-10">
                      <form method="POST" action="{{url('/addPost')}}"  enctype= "multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_body" type="post_body" class="form-control @error('post_body') is-invalid @enderror" rows="7" name="post_body" value="{{ old('post_body') }}" required autocomplete="post_body">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary btn-larg btn-block">
                                    {{ __('Published Post') }}
                                </button>
                            </div>
                        </div>
