...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header header">Edit Post</div>
                    ...
                    <div class="col-md-12 col-xs-10">
                      <form method="POST" action="{{url('/editPost',array($posts->id))}}"  enctype= "multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_body" type="post_body" class="form-control @error('post_body') is-invalid @enderror" rows="7" name="post_body"  required autocomplete="post_body">{{ $posts->post_body }}
                                </textarea>
