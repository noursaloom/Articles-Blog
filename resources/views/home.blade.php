  ...
  <div class="row justify-content-center">
            ...
            @csrf
             <div class="input-group">
              ...
              <span class="input-group-btn">
                <button type="submit" class="btn btn-default btn-new color-blue">Go!</button>
              </span>
            </div><!-- /input-group -->
          </form>
        </div>
    ...
    <div class="card-body">
      ...
      <div class="panel-body">
        <div class="row">
         <div class="col-md-4" style="border-right: 1px solid #e5e5e5;" align="center">
          @if(!empty($profile))
          <img src="{{ $profile->profile_pic}}" class="avatar" />
          <h3 class="lead" >{{$profile->name}}</h3>
          <h5 class="lead">{{$profile->designation}}</h5>                      
          @else
